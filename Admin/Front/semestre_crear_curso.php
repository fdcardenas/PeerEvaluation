                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <form role="form" id="courseCreationForm">
                                    ...
                                    <div class="form-group">
                                        <button id="seleccionar_profesor" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-small">
                                    ...
                                    <button type="button" id="click_crear_nuevo_curso" class="btn btn-primary">Crear curso</button>
                                    </div>
                                </form>
                    ...
                    if(h.exito=="exito"){
                        ...
                        for(i=0;i<h.n;i++){
                            t.fnAddData([
                                h[i][0],
                                h[i][1],
                                '<input type="checkbox" class="checkbox" value="'+h[i][0]+'" nombre="'+h[i][1]+'">'
                            ...
                            var cadena="";
                                ...
                                if(ids.length==0){
                                    ...
                                    cadena=cadena+'<div class="form-group">'+
                                            '<label>Profesor agregado: '+nombres[0]+'</label>'+
                                            '</div>';
                                    ...
                                    cadena="";
                                    cadena=cadena+'<div class="form-group">'+
                                            '<label>Profesores agregados: '+nombres[0]+' y '+nombres[1]+'</label>'+
                                            '</div>';
                                    $("#sub_profesores").empty();
                                    $("#sub_profesores").append(cadena);
                                    $('#myModal').modal('hide');
